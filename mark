软件应包括指明的完整功能，重点考察其正确性、易用性、健壮性。
软件文档应包括：需求分析说明书、系统设计文档、软件测试报告， 重点考察其规范性、一致性、可读性

基本要求 各项目组根据自身情况自行选择扩展要求（对应扩展分总分）。 
...
开发语言选择：C/C++/C#/Java/Go；用户界面可以采用脚本语言编写；后台逻辑若也选择脚本语言，则小组基础分记10分。 库的使用：对所有扩展功能，如使用第三方库/程序/代码“直接”实现，对应功能扩展分总分记为原来的50%。
